...
export function PromotionCardd({ proyecto, small }: any) {
  ...
  return (
    ...
    //     <div
    //       className="relative overflow-hidden rounded-md aspect-[4/3] sm:aspect-[3/2] p-4 sm:p-6 flex flex-col justify-between"
    //       style={{
    //         backgroundImage: `url(${proyecto.content.imagen_portada.filename})`,
    //         backgroundSize: 'cover',
    //         backgroundPosition: 'center',
    ...
    //               <span className="text-neutral-100 text-sm mb-1">
    //                 Mensualidades desde
    //               </span>
    //               <span className="leading-4 font-heading sm:text-2xl">
    //                 {proyecto.content.promociones[0].mensualidades}
    //               </span>
    //             </div>
    //           </div>
    ...
    //           <span className="text-neutral-100 text-sm mb-1">
    //             {proyecto.content.tipo.includes('Terrenos')
    //               ? 'Terrenos residenciales desde'
    //               : 'Residencias desde'}
    //           </span>
    //           <span className="leading-4 sm:text-2xl font-heading text-right">
    //             {proyecto.content.precio}
    //           </span>
    //         </div>
    //       </div>
